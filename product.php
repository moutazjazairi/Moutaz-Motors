...
<!-- Replace the previous link with the below one -->
...
<script>// Select all necessary elements
...
filterBtn.addEventListener('click', function(event) {
    ...
    var selectedPrice = priceSelect.value.split('-'); // price should be in a range format like '0-100'
    
    // Convert selected price to numbers
